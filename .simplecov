# kettle-jem:freeze
# To retain chunks of comments & code during activesupport-tagged_logging templating:
# Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
# activesupport-tagged_logging will then preserve content between those markers across template runs.
# kettle-jem:unfreeze
